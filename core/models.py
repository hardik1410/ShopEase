...
class Owner(AbstractBaseUser, PermissionsMixin):
    ...
    allergicIngredients = models.CharField(
        db_column='AllergicIngredients', max_length=500, null=True)
    contact = models.CharField(
        max_length=12, db_column='CustomerContact', blank=True)
...
class Store(models.Model):
    storeId = models.AutoField(
        db_column='StoreId', auto_created=True, primary_key=True)
    ...
    primaryContact = models.CharField(
        max_length=12, db_column='PrimaryContact', blank=True)
    secondaryContact = models.CharField(
        max_length=12, db_column='SecondaryContact', null=True)
...
class Category(models.Model):
    storeId = models.ForeignKey(
        Store, db_column='StoreId', on_delete=models.CASCADE)
    categoryId = models.AutoField(
        db_column='CategoryId', auto_created=True, primary_key=True)
...
class Product(models.Model):
    ...
    productId = models.AutoField(
        db_column='ProductId', auto_created=True, primary_key=True)
    categoryId = models.ForeignKey(
        Category, db_column='CategoryId', on_delete=models.CASCADE)
    product_name = models.CharField(db_column='Name', max_length=100)
    description = models.CharField(
        db_column='Description', max_length=500, null=True)
    quantity = models.IntegerField(db_column='Quantity', null=True)
    price = models.DecimalField(
        db_column='Price', max_digits=7, decimal_places=2, null=True)
    discount = models.DecimalField(
        db_column='Discount', max_digits=3, decimal_places=2, null=True)
    ...
    ingredients = models.CharField(
        db_column='Ingredients', max_length=500, null=True)
    fromDate = models.DateField(db_column='FromDate', null=True)
    thruDate = models.DateField(db_column='ThruDate', null=True)
    creator = models.CharField(db_column='Creator', max_length=30, null=True)
    created = models.DateField(db_column='Created', null=True)
...
class ProductImage(models.Model):
    imageId = models.AutoField(
        db_column="ImageId", auto_created=True, primary_key=True)
    imagePath = models.ImageField(upload_to='images')
    productId = models.IntegerField(
        db_column='productId', unique=True, null=True)
...
class Order(models.Model):
    ...
    customerId = models.ForeignKey(
        Owner, db_column='CustomerId', on_delete=models.CASCADE)
    orderDate = models.DateTimeField(db_column="OrderDate")
    orderType = models.CharField(
        db_column="OrderType", choices=CHOICES, null=True, max_length=15)
    OrderAmount = models.DecimalField(
        db_column="OrderAmount", max_digits=7, decimal_places=2)
    status = models.CharField(db_column="OrderStatus",
                              choices=CHOICES_STATUS, null=True, max_length=15)
...
class OrderProduct(models.Model):
    ...
    amount = models.DecimalField(
        db_column="Amount", max_digits=7, decimal_places=2)
